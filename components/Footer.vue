<template>
  <footer class="bg-white">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2024 Creative REI, Inc. All rights reserved.</p>
    </div>
  </footer>
</template>
...
const navigation = {
  main: [
    ...
    { name: 'Send me a lead', href: '/send-me-a-lead/steps/0' },
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/EstebannIbarraa/photos',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/e_steban/?hl=en',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@E_steban',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
