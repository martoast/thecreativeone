      ...
      <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">Connect with us to explore how we can assist you in achieving your real estate goals. Whether you have questions, need expert advice, or are ready to embark on your next investment journey, our team is here to help.</p>
            <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
              ...
              <div class="flex gap-x-4">
                ...
                <dd><a class="hover:text-gray-900" href="tel:+1 (956) 382-4168">+1 (956) 382-4168</a></dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-gray-900" href="mailto:esteban.j.ibarra@gmail.com">esteban.j.ibarra@gmail.com</a></dd>
              </div>
            </dl>
          </div>
        </div>
