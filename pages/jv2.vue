      ...
      <form @submit.prevent="submitJointVentureForm" class="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div class="sm:col-span-2">
            ...
            <input type="tel" name="number" id="number" v-model="form.number" class="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
          ...
          <div class="sm:col-span-2">
            ...
            <input type="text" name="address" id="address" v-model="form.address" class="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
  
          <!-- City -->
          <div>
            <label for="city" class="block text-sm font-semibold leading-6 text-gray-900">City</label>
            <input type="text" name="city" id="city" v-model="form.city" class="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
  
          <!-- State -->
          <div>
            <label for="state" class="block text-sm font-semibold leading-6 text-gray-900">State</label>
            <input type="text" name="state" id="state" v-model="form.state" class="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
  
          <!-- Zip -->
          <div>
            <label for="zip" class="block text-sm font-semibold leading-6 text-gray-900">Zip</label>
            <input type="text" name="zip" id="zip" v-model="form.zip" class="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
...
const submitJointVentureForm = async () => {
  ...
  const payload = {
    jointVenture: {
      ...form.value,
      fullAddress: `${form.value.address}, ${form.value.city}, ${form.value.state} ${form.value.zip}`
    }
  };
  ...
  try {
    ...
    Object.keys(form.value).forEach(key => {
      form.value[key] = typeof form.value[key] === 'number' ? null : "";
    });
  } catch (error) {
