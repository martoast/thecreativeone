<template>
  ...
  import { ref } from 'vue'
  import FourthStep from '~/components/LeadForm/Steps/FourthStep.vue';
  import StepsNav from '~/components/LeadForm/StepsNav.vue';
  ...
  const formData = ref($locally.getItem('formData') ?? {});
  </script>